...
import 'package:xhat_app/wigets/chat_bubble.dart';
import 'package:xhat_app/wigets/chat_input.dart';
...
class _ChatPageState extends State<ChatPage> {
  ...
  _loadInitialMessages() async {
    final response = await rootBundle.loadString('images/mock_messages.json');
